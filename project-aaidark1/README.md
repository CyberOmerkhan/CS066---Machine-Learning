...
This project implements Physics-Informed Neural Networks (PINNs) to solve the Black-Scholes-Merton partial differential equation for option pricing. By embedding the fundamental "no-arbitrage" principle directly into the neural network's loss function, the model learns to price financial derivatives with high mathematical consistency and minimal data requirements.
